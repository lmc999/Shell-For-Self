...
nohup udp2raw -c -r44.55.66.77:9898 -l 127.0.0.1:9999 --raw-mode faketcp -a -k passwd >udp2raw.log 2>&1 &
...
echo "nohup udp2raw -c -r44.55.66.77:9898 -l 127.0.0.1:9999 --raw-mode faketcp -a -k passwd >udp2raw.log 2>&1 &" | sudo tee -a /etc/rc.local
